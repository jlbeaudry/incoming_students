...
Of those who started the survey (*n* = `r n`), `r el[5,2]` were eligible based on starting 
their first unit of study in psychology at a university within the next month. 

<!-- [[ Breadcrumbs: work through the eligibility criteria from the prereg ]] -->
