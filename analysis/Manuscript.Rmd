...
# combine means & SDs
prac_means$Practice <- prac_means$practice
...
# use p_tidy? to clean up the pvalues
# round the corr & CI
# join with the practice_means tibble & turn into a table
