...
practice_means$Practice <- c("Critical thinking", "HARKing", "Info for replicability", "Open access", "Open data", "Open materials", "p-hacking", "Preprints", "Preregistration", "Registered Reports")


knitr::kable(practice_means,
             caption = "Means, standard deviations, and 95% confidence intervals (in square brackets) for norms, counternorms, and the difference between norms and counternorms",
             digits = 2,
             align = c('lccc'))
...
in_practice_means$Practice <- c("Data on request", "Info for replicability", "HARKing", "p-hacking", "Open access", "Open data", "Open materials", "Preprints", "Pre-registration", "Registered report")
...
corr$Practice <- c("Critical thinking", "HARKing", "Info for replicability", "Open access", "Open data", "Open materials", "p-hacking", "Preprints", "Preregistration", "Registered reports")
