...
#import the data. 
df2 <- read.csv (here::here("data", "students_processed.csv"))
# [[breadcrumbs: work on parsing the columns. It could be that I didn't need to 
# write them as factors in the preprocessing]]
df3 <- read.csv (here::here("data", "students_processed.csv"), 
                 colClasses = c('numeric','factor','factor',
                                rep('character', 3),
                                rep('factor', 2), 'character', 
                                rep('numeric', 35), rep('character', 3),
                                rep('factor', 4), rep('character', 2),
                                rep('factor', 21))
                 )
...
# I fell down a massive git hub hole, so I'll make progress on this tomorrow!
