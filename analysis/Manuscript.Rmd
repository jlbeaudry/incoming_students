...
read_csv(col_names = TRUE, skip_empty_rows = TRUE, lazy = FALSE) %>%
...
Most participants (*n* = `r gender[1,2]`) reported that they were female, 
...
non-binary gender. *We still need to fix this...see email from Nov 12th*
