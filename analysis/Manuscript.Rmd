...
```{r crisis descriptions, eval=FALSE, include=FALSE}
...
<!-- This needs another csv file in order to run the code above. Also, revise where the csv file is written to and loaded from.  -->
