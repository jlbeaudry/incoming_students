...
wordcount: X
bibliography: [Matt_Zotero_Library.bib,r-references.bib]
floatsintext: yes
figurelist: no
tablelist: no
footnotelist: no
...
Of those who started the survey (*n* = `r n_all`), we screened out participants who 
were not eligible to participate based on our preregistration. Specifically, 
we screened out people who were younger than 18 years of age (*n* = `r age[1,2]`). 
We also screened out individuals who had already started a psychology unit at a
university, regardless of whether they completed it (*n* = `r el[1,2] + el[3,2] + el[4,2]`); 
were not enrolled in a psychology unit at a university (*n* = `r el[2,2]`); or did 
not answer this question (*n* = `r el[6,2]`). The remaining `r el[5,2]` participants
...
`r age [7,2]` were 65 years or older. A small number of participants did not 
report their age(*n* = `r age [8,2]`). 
