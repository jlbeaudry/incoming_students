...
abstract: |
 Background: Understanding students’ naive conceptions about how science works and the norms that guide scientific best practice is important so that teachers can adapt to students’ existing understandings.
 Objective: We aimed to describe what incoming undergraduate students of psychology believe about reproducibility and open science practices.
 ...
 Conclusion: Despite media attention about the replication crisis, few incoming psychology students in our sample were familiar with the term. The students were nevertheless in favour of most open science practices, although they appeared to overestimate the prevalence of some of these practices in psychology.
...
# Methods
We preregistered the exploratory nature of this study at https://tinyurl.com/4p64mvwp [blinded]. Our materials, data, and analysis script are available at https://tinyurl.com/excm4heu [blinded]. Ethical approval for this study was granted by [blinded].
...
Our approach to measuring norms and counternorms focussed on participants' evaluations of ten specific open science practices that reflected diverse open science norms (see Table \@ref(tab:normcounternormitems)). Although we acknowledge the merits of some of these practices are debatable [@TQMP16-4-376; @rubinWhenDoesHARKing2017; @szollosiPreregistrationWorthwhile2020], we selected the items to be emblematic of common concerns in the open science movement.
...
For teachers interested in systematically surveying their students' existing understanding of open science practices in psychology, our survey questions could be a useful resource. These questions are available at https://tinyurl.com/excm4heu [blinded].
